...
the command {\tt OreGroebnerBasis}, which is part of the package {\tt
 ...
 such that\footnote{Details are provided in the  attached {\tt
     Mathematica}  notebook with  this example is accessible at \href{https://github.com/pierrevanhove/TwistedGriffithsDwork/blob/main/Mathematica/Cross-AdS.nb}{Cross-AdS.nb}.}
 \begin{equation}
...
$\epsilon$, respectively. The results are provided on the {\tt
  SageMath} worksheet \href{https://nbviewer.org/github/pierrevanhove/TwistedGriffithsDwork/Worksheets/blob/main/Sunset-Twoloop-3mass-Epsilon.ipynb}{Sunset-Twoloop-3mass-Epsilon.ipynb} .
%
...
the {\tt
  SageMath} worksheet \href{https://nbviewer.org/github/pierrevanhove/TwistedGriffithsDwork/Worksheets/blob/main/IceCream-Epsilon.ipynb}{IceCream-Epsilon.ipynb}.)
\begin{itemize}
	...
	\begin{equation}
		\mathscr{L}_{\IceCream,3}^{[41^3],0}=\mathscr{L}_{a,1}^0 \circ \mathscr{L}_{\IceCream}^{[41^3],0} \,,      
	\end{equation}
	...
	on this
	page~\href{https://nbviewer.org/github/pierrevanhove/PicardFuchs/blob/main/PF-icecream-2loop.ipynb}{PF-icecream-2loop.ipynb}). The
	...
	$\epsilon^0$ term factorises as
	\begin{equation}
		\mathscr{L}_{\IceCream,3}^{[21^5],0}=\mathscr{L}_{a,1}^0 \circ \mathscr{L}_{\IceCream}^{[21^5] ,0      } \, ,
	\end{equation}
	where $\mathscr{L}_{a,1}^0$ is a first order operator and the second order
	...
	$\epsilon^0$ term factorises as
	\begin{equation}
		\mathscr{L}_{\IceCream,4}^{[1^7],0}=\mathscr{L}_{a,1}^0 \circ \mathscr{L}_{b,1}^0 \circ \mathscr{L}_{\IceCream}^{[1^7] ,0      } \, ,
	\end{equation}
...
\begin{equation}
  ...
  one finds the following Gr\"obner basis of differential operators\footnote{Details are provided in the  attached {\tt
     Mathematica}  notebook with  this example is accessible at \href{https://github.com/pierrevanhove/TwistedGriffithsDwork/blob/main/Mathematica/Icecream-AdS.nb}{Icecream-AdS.nb}.}
  \begin{align}
 ...
 \mathscr{L}_3&=       2u^2 \left((u-v)^2+1-2(u+v)\right) \left(\partial\over
                \partial u\right)^3\cr
                &+v\left(9 \kappa  \left((u+v-1)^2-2uv\right)-u^2+9 u^2-(v-1)^2-8u(1+v)\right)\left(\partial\over\partial
                  v\right)^2\cr
                  &+\left(\kappa^2\left(-29 u^2+u (43 v+29)-18 (v-1)^2\right)+ \kappa\left(6 u (v+3)-6 (v-1)^2\right)   +u (5 u-v+1)\right){\partial\over\partial u}\cr
                    &+\Big(\kappa ^2 \left(27 u^2-59 u v-54 u+36 v^2-63 v+27\right)-3 \kappa  \left(-9 u^2+6 u v+8 u+3 v^2-4 v+1\right)\cr
                      &-v (u+3 v-3)\Big){\partial\over\partial v}+24 (\kappa -1) \kappa ^2 (v-u-1)\,.
  \end{align}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
The results for the differential equation are given on the {\tt
  SageMath} worksheet \href{https://nbviewer.org/github/pierrevanhove/TwistedGriffithsDwork/Worksheets/blob/main/Sunset-1mass-Epsilon.ipynb}{Sunset-1mass-Epsilon.ipynb}.
%-------------------------------------------------------------------------
...
results which are as well given on the  {\tt
  SageMath} worksheet \href{https://nbviewer.org/github/pierrevanhove/TwistedGriffithsDwork/Worksheets/blob/main/Sunset-Threeloop-Epsilon.ipynb}{Sunset-Threeloop-Epsilon.ipynb}. With the notation of Section~4 of~\cite{Lairez:2022zkj}:
%
\begin{itemize}
