...
three-loop order. Additionally, we present the operators
...
\begin{align}
  \vec B_\Box^\epsilon&=\left\{\frac{x_4}{2 X+2},-\frac{x_1+x_2+x_3}{2
                   X^2+2 X},\frac{x_4}{2 X+2},-\frac{x_4 (2 X+1)}{2
                   X (X+1)}\right\}\cr
                   &+\lambda_{0,0,1,0}^3 \left\{\frac{x_4
                     X-x_1}{\epsilon +2},\frac{x_1-x_3}{\epsilon
                     +2},\frac{x_3-x_4 X}{\epsilon +2},0\right\}\cr
                     &+\lambda_{0,0,1,0}^4 \left\{\frac{(x_4-x_2)
                       X}{\epsilon +2},\frac{x_2 X-x_3}{\epsilon
                       +2},0,\frac{x_3-x_4 X}{\epsilon
                       +2}\right\}\cr
                       &+\lambda_{1,0,0,0}^4 \left\{0,\frac{x_2 X-x_1}{\epsilon +2},\frac{(x_4-x_2) X}{\epsilon +2},\frac{x_1-x_4 X}{\epsilon +2}\right\}.
\end{align}
