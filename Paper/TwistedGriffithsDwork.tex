...
\begin{figure}[ht]
	...
	\begin{tikzpicture}[very thick]
		...
		\node[text width=0.5cm, text centered ] at (-1.3,1.3){$x_2$};
		\node[text width=0.5cm, text centered ] at (-1.3,-1.3){$x_1$};
		\node[text width=0.5cm, text centered ] at (1.3,-1.3){$x_4$};
		\node[text width=0.5cm, text centered ] at (1.3,1.3){$x_3$};
	\end{tikzpicture}
...
\begin{figure}[h]
	\centering\begin{tikzpicture}[scale=0.7]
		...
		\node[text width=0.5cm, text centered ] at (-1.,1.0) {$a$};
		\node[text width=0.5cm, text centered ] at (-1.,-1.) {$a$};
		\node[text width=0.5cm, text centered ] at (1.,1.0) {$a$};
		\node[text width=0.5cm, text centered ] at (1.,-1.) {$a$};
		\node[text width=0.5cm, text centered ] at (0.4,0.) {$a$};
...
\end{equation}
\begin{multline}
\mathbf F _{\Kite}(m^2,p^2)=p^2 (x_1 x_2 x_3 x_4\sum_{i=1}^4 x_i^{-1}+(x_1+x_4)(x_2+ x_3) x_5)
...
\begin{figure}[h]
	...
	\node[text width=0.5cm, text centered ] at (-1.5,-1.) {$a$};
	\node[text width=0.5cm, text centered ] at (0,1.5) {$a$};
	\node[text width=0.5cm, text centered ] at (1.5,-1.) {$a$};
	\node[text width=0.5cm, text centered ] at (0.,0.2) {$a$};
	\node[text width=0.5cm, text centered ] at (-3.5,0.0) {$k$};
	\node[text width=0.5cm, text centered ] at (0,-3.5) {$k$};
	\node[text width=0.5cm, text centered ] at (3.5,0) {$k$};
	\end{tikzpicture}
...
\begin{figure}[h]
	\centering	\begin{tikzpicture}[scale=0.7]
		...
		\node[text width=0.5cm, text centered ] at (-1.5,-1.) {$a$};
		\node[text width=0.5cm, text centered ] at (-1.5,1.) {$a$};
		\node[text width=0.5cm, text centered ] at (1.5,1.7) {$a$};
		\node[text width=0.5cm, text centered ] at (1.5,-1.7) {$a$};
		\node[text width=0.5cm, text centered ] at (0.5,-0.5) {$a$};
		\node[text width=0.5cm, text centered ] at (0.5,0.5) {$a$};
		\node[text width=0.5cm, text centered ] at (-3.5,0.0) {$k$};
		\node[text width=0.5cm, text centered ] at (3.5,-1.5) {$k$};
		\node[text width=0.5cm, text centered ] at (3.5,1.5) {$k$};
	\end{tikzpicture}
...
\begin{figure}[h]\centering
	\begin{tikzpicture}[scale=0.8]
		...
		\node[text width=0.5cm, text centered ] at (-1.2,0) {$2$};
		...
		\node[text width=0.5cm, text centered ] at (2,1.3) {$5$};
		\node[text width=0.5cm, text centered ] at (1.2, 0) {$4$};
		\node[text width=0.5cm, text centered ] at (0,1.3) {$3$};
		\node[text width=0.5cm, text centered ] at (-1.5,1.5){$k_2$};
		\node[text width=0.5cm, text centered ] at (3.5,1.5){$k_3$};
		\node[text width=0.5cm, text centered ] at (3.5,-1.5){$k_4$};
		\node[text width=0.5cm, text centered ] at (-1.5,-1.5){$k_1$};
	\end{tikzpicture} 
	\caption{The planar massless double-box graphs}\label{fig:doublebox}
	 \end{figure}
...
\begin{figure}[h]\centering
	...
	\begin{tikzpicture}[scale=0.6]
		...
		\draw [black,dashed] (2.5,1.5) to (3.0,1.5);
	\end{tikzpicture}
	\caption{The non-planar massless double-box graphs}\label{fig:npdoublebox}
\end{figure}
