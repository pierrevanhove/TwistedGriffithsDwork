...
form  in  $D=2\delta-2\epsilon$ with $\delta\in\mathbb N^*$ and
$\epsilon\in\mathbb R$\footnote{We do not assume that $\epsilon$ is
  ...
  clearer the role of the twist from the non integer space-time dimension.}
\begin{equation}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{The Extended Griffiths-Dwork reduction}
\label{sec:Red}
