...
\usepackage{amsmath,amssymb,amsthm,comment,bm,setspace,mathtools}
%\usepackage{lmodern}
%\usepackage{helvet}
...
\author[Leonardo de la Cruz]{Leonardo de la Cruz}
 \address{
Institut de Physique Th{\'e}orique, Universit{\'e} Paris Saclay,
CNRS, CEA, F-91191 Gif-sur-Yvette, France}
\author[Pierre Vanhove]{Pierre Vanhove}
 \address{
Institut de Physique Th{\'e}orique, Universit{\'e} Paris Saclay,
CNRS, CEA, F-91191 Gif-sur-Yvette, France}
%\address{National Research University Higher School of Economics, Russian Federation}
%\email{pierre.vanhove@cea.fr}
 \begin{abstract}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\part{Twisted Griffith-Dwork reduction}
...
\section{The Griffiths-Dwork reduction}
...
%
We reduce this polynomial in the Jacobian ideal of  $ \textbf{F}_\Gamma$
...
\part{The Sunset integral in general dimensions}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Minimal differential equation for the one-loop sunset}\label{sec:one-loop-case}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Differential equation for the  two-loop sunset}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   \section{Minimal differential operator for higher-loop sunset}
...
possible mass configurations.
   ...
   \subsection{The all equal mass case}
...
%------------------------------------------------------------------------------------------------------------
\subsection{The three-loop generic mass cases}\label{sec:threeloop}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\part{The ice-cream cone in general dimensions}\label{sec:ice-cream}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\part{Minimal order Picard-Fuchs operator and number of master integrals}
...
We would like to thank Pierre Lairez, Eric Pichon-Pharabod, Leonardo
de la Cruz for discussions.
